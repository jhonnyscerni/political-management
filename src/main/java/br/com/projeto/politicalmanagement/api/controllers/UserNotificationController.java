...
import br.com.projeto.politicalmanagement.api.request.NotificationRequest;
...
public class UserNotificationController {
    ...
    public ResponseEntity<Object> updateNotification(@PathVariable(value="userId") UUID userId,
        ...
        notificationModelOptional.get().setNotificationStatus(notificationRequest.getNotificationStatus());
